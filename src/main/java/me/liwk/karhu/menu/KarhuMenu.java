...
public class KarhuMenu {
    ...
    public static void openMenu(Player opener) {
        ...
        Gui gui = new Gui(ChatColor.translateAlternateColorCodes('&', Karhu.getInstance().getConfigManager().getAlertHoverMessageHighlight() + "&l" + Karhu.getInstance().getConfigManager().getName() + "&7 - Menu"), 9 * 3);
        ...
        gui.addButton(new Button(1, 11, ItemUtil.makeItem(Material.BEACON, 1,  cfg.getGuiHighlightColor() + "Checks", Arrays.asList(
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
        ...
        gui.addButton(new Button(1, 13, ItemUtil.makeItem(Material.DIAMOND_CHESTPLATE, 1, cfg.getGuiHighlightColor() + "Info", Arrays.asList(
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
            ...
            public void onClick(Player clicker, ClickType clickType) {
                ...
                this.inv.setItem(this.pos, item);

            }
        });

        if(Karhu.SERVER_VERSION.isNewerThan(ServerVersion.V_1_12_2)) {
            gui.addButton(new Button(1, 15, ItemUtil.makeItem(Material.WRITABLE_BOOK, 1, cfg.getGuiHighlightColor() + "Settings", Arrays.asList(
                    "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                    "§7Control settings",
                    "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
            ))) {
            ...
            gui.addButton(new Button(1, 15, ItemUtil.makeItem(Material.getMaterial("BOOK_AND_QUILL"), 1, cfg.getGuiHighlightColor() + "Settings", Arrays.asList(
                    "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                    "§7Control settings",
                    "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
            ))) {
