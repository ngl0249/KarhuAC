...
public class PlayerInfoMenu {
    public static void openMenu(Player opener, Player target) {
        ...
        Gui gui = new Gui(cfg.getGuiHighlightColor() + target.getName(), 27);
        ...
        if(Karhu.SERVER_VERSION.isNewerThan(ServerVersion.V_1_12_2)) {
            gui.addButton(new Button(1, 11, ItemUtil.makeSkullItem(target.getName(), 1, cfg.getGuiHighlightColor() + target.getName(), false, Arrays.asList(
                    "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
            ...
            gui.addButton(new Button(1, 11, ItemUtil.makeSkullItem(target.getName(), 1, cfg.getGuiHighlightColor() + target.getName(), true, Arrays.asList(
                    "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                    cfg.getGuiHighlightColor() + "Ping §7➟ §f" + data.getTransactionPing() + " | " + data.getPing(),
                    cfg.getGuiHighlightColor() + "Last lag §7➟ §f" + (((data.getTotalTicks() - data.lastPacketDrop) * 50) / 1000) + "s ago",
                    "",
        ...
        gui.addButton(new Button(1, 12, ItemUtil.makeItem(Material.NAME_TAG, 1, cfg.getGuiHighlightColor() + "Info", Arrays.asList(
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                cfg.getGuiHighlightColor() + "Game session §7➟ §f" + (System.currentTimeMillis() - data.getLastJoinTime()) / 1000 / 60 / 60 + "h" + " " + (System.currentTimeMillis() - data.getLastJoinTime()) / 1000 / 60 + "m",
        ...
        gui.addButton(new Button(1, 15, ItemUtil.makeItem(Material.BOOK, 1, cfg.getGuiHighlightColor() + "Logs", Arrays.asList(
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                "§7Show logs",
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
        ))) {
