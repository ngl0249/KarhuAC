...
public class SettingsMenu {
    ...
    public static void openSettingMenu(Player opener) {
        ...
        Gui gui = new Gui(ChatColor.translateAlternateColorCodes('&', cfg.getGuiHighlightColor() + Karhu.getInstance().getConfigManager().getName() + "§7 - Settings"), 27);
        ...
        gui.addButton(new Button(1, 10, ItemUtil.makeItem(getItem(Karhu.getInstance().getConfigManager().isAnticrash()), 1, cfg.getGuiHighlightColor() + "Anticrash", Arrays.asList(
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                "§7Enabled: " + getCheckMark(Karhu.getInstance().getConfigManager().isAnticrash()),
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
        ))) {
            @Override
            public void onClick(Player clicker, ClickType clickType) {
                ...
                stack.setType(getItem(Karhu.getInstance().getConfigManager().isAnticrash()));
                this.inv.setItem(this.pos, stack);
            }
        });

        gui.addButton(new Button(1, 11, ItemUtil.makeItem(getItem(Karhu.getInstance().getConfigManager().isAutoban()), 1, cfg.getGuiHighlightColor() + "Autoban", Arrays.asList(
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                "§7Enabled: " + getCheckMark(Karhu.getInstance().getConfigManager().isAutoban()),
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
        ))) {
            @Override
            public void onClick(Player clicker, ClickType clickType) {
                ...
                stack.setItemMeta(meta);
                stack.setType(getItem(Karhu.getInstance().getConfigManager().isAutoban()));
                this.inv.setItem(this.pos, stack);
            }
        });

        gui.addButton(new Button(1, 12, ItemUtil.makeItem(getItem(Karhu.getInstance().getConfigManager().isPunishBroadcast()), 1, cfg.getGuiHighlightColor() + "Punishment broadcast", Arrays.asList(
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                "§7Enabled: " + getCheckMark(Karhu.getInstance().getConfigManager().isPunishBroadcast()),
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
        ))) {
            @Override
            public void onClick(Player clicker, ClickType clickType) {
                ...
                stack.setItemMeta(meta);
                stack.setType(getItem(Karhu.getInstance().getConfigManager().isPunishBroadcast()));
                this.inv.setItem(this.pos, stack);
            }
        });

        gui.addButton(new Button(1, 13, ItemUtil.makeItem(getItem(Karhu.getInstance().getConfigManager().isBypass()), 1, cfg.getGuiHighlightColor() + "Bypass permission", Arrays.asList(
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                "§7Enabled: " + getCheckMark(Karhu.getInstance().getConfigManager().isBypass()),
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
        ))) {
            @Override
            public void onClick(Player clicker, ClickType clickType) {
                ...
                stack.setItemMeta(meta);
                stack.setType(getItem(Karhu.getInstance().getConfigManager().isBypass()));
                this.inv.setItem(this.pos, stack);
            }
        });

        gui.addButton(new Button(1, 14, ItemUtil.makeItem(getItem(Karhu.getInstance().getConfigManager().isClientCheck()), 1, cfg.getGuiHighlightColor() + "Client check", Arrays.asList(
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                "§7Enabled: " + getCheckMark(Karhu.getInstance().getConfigManager().isClientCheck()),
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
        ))) {
            @Override
            public void onClick(Player clicker, ClickType clickType) {
                ...
                stack.setItemMeta(meta);
                stack.setType(getItem(Karhu.getInstance().getConfigManager().isClientCheck()));
                this.inv.setItem(this.pos, stack);
            }
        });

        gui.addButton(new Button(1, 15, ItemUtil.makeItem(getItem(Karhu.getInstance().getConfigManager().isPullback()), 1, cfg.getGuiHighlightColor() + "Pullback", Arrays.asList(
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
            ...
            public void onClick(Player clicker, ClickType clickType) {
                ...
                stack.setItemMeta(meta);
                stack.setType(getItem(Karhu.getInstance().getConfigManager().isPullback()));
                this.inv.setItem(this.pos, stack);
            }
        });

        gui.addButton(new Button(1, 16, ItemUtil.makeItem(getItem(Karhu.getInstance().getConfigManager().isDiscordAlert()), 1, cfg.getGuiHighlightColor() + "Discord webhook", Arrays.asList(
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                "§7Enabled: " + getCheckMark(Karhu.getInstance().getConfigManager().isDiscordAlert()),
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
        ))) {
            @Override
            public void onClick(Player clicker, ClickType clickType) {
                ...
                stack.setItemMeta(meta);
                stack.setType(getItem(Karhu.getInstance().getConfigManager().isDiscordAlert()));
                this.inv.setItem(this.pos, stack);
            }
        });
