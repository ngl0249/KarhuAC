...
public class ViolationMenu {
    ...
    public static void openViolationGui(Player opener, Check check, CheckInfo checkInfo, SubCategory subCategory) {
        ...
        Gui gui = new Gui(ChatColor.translateAlternateColorCodes('&', Karhu.getInstance().getConfigManager().getAlertHoverMessageHighlight() + "&l" + Karhu.getInstance().getConfigManager().getName() + "&7 - " + checkInfo.name()), 27);

        String name = checkInfo.name();

        if(Karhu.SERVER_VERSION.isNewerThan(ServerVersion.V_1_12_2)) {
            gui.addButton(new Button(1, 9, ItemUtil.makeItem(
                    Material.RED_STAINED_GLASS_PANE, 1,
                    cfg.getGuiHighlightColor() + "§2-1VL", Arrays.asList(
                    "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                    "§7Subtract by §c1 vl",
                    "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
            ))) {
                ...
                public void onClick(Player clicker, ClickType clickType) {
                    ...
                    int newVl = updateCheckVl(check, 1, false);
                    ...
                    //ViolationMenu.openViolationGui(clicker, check, checkInfo, subCategory);

                    updateCheckMiddle(this, checkInfo, name);
                }
            });

            gui.addButton(new Button(1, 10, ItemUtil.makeItem(
                    Material.RED_STAINED_GLASS_PANE, 1,
                    "§c-5VL", Arrays.asList(
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                            "§7Subtract by 5 vl",
                ...
                public void onClick(Player clicker, ClickType clickType) {
                    ...
                    int newVl = updateCheckVl(check, 5, false);
            ...
            gui.addButton(new Button(1, 11, ItemUtil.makeItem(
                    Material.RED_STAINED_GLASS_PANE, 1,
                    "§c-10VL", Arrays.asList(
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                            "§7Subtract by §c10 vl",
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
                    ))) {
                ...
                public void onClick(Player clicker, ClickType clickType) {
                    ...
                    int newVl = updateCheckVl(check, 10, false);
            ...
            gui.addButton(new Button(1, 9, ItemUtil.makeItem(
                    Material.getMaterial("STAINED_GLASS_PANE"), (short) 14, 1,
                    cfg.getGuiHighlightColor() + "§c-1VL", Arrays.asList(
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                            "§7Substract by §c1 vl",
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
                    ))) {
            ...
            gui.addButton(new Button(1, 10, ItemUtil.makeItem(
                    Material.getMaterial("STAINED_GLASS_PANE"), (short) 14, 1,
                    cfg.getGuiHighlightColor() + "§c-5VL", Arrays.asList(
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                            "§7Substract by §c5 vl",
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
                    ))) {
            ...
            gui.addButton(new Button(1, 11, ItemUtil.makeItem(
                    Material.getMaterial("STAINED_GLASS_PANE"), (short) 14, 1,
                    cfg.getGuiHighlightColor() + "§c-10VL", Arrays.asList(
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                            "§7Substract by §c10 vl",
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
                    ))) {
                @Override
                public void onClick(Player clicker, ClickType clickType) {
        ...
        gui.addButton(new Button(1, 13, ItemUtil.makeItem(Karhu.getInstance().getCheckState().isEnabled(checkInfo.name())
                ? Material.ENCHANTED_BOOK : Material.BOOK, 1, cfg.getGuiHighlightColor() + (checkInfo.experimental() ? checkInfo.name() + "§aΔ" : checkInfo.name()), checkInfo.credits().equals("") ? Arrays.asList(
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
        ...
        if(Karhu.SERVER_VERSION.isNewerThan(ServerVersion.V_1_12_2)) {
            gui.addButton(new Button(1, 15, ItemUtil.makeItem(
                    Material.GREEN_STAINED_GLASS_PANE, 1,
                    cfg.getGuiHighlightColor() + "§21VL", Arrays.asList(
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                            "§7Additon by §21 vl",
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
                    ))) {
                ...
                public void onClick(Player clicker, ClickType clickType) {
                    ...
                    int newVl = updateCheckVl(check, 1, true);
            ...
            gui.addButton(new Button(1, 16, ItemUtil.makeItem(
                    Material.GREEN_STAINED_GLASS_PANE, 1,
                    "§25VL", Arrays.asList(
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                            "§7Additon by §25 vl",
                ...
                public void onClick(Player clicker, ClickType clickType) {
                    ...
                    int newVl = updateCheckVl(check, 5, true);
            ...
            gui.addButton(new Button(1, 17, ItemUtil.makeItem(
                    Material.GREEN_STAINED_GLASS_PANE, 1,
                    "§2-0VL", Arrays.asList(
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                            "§7Additon by §210 vl",
                ...
                public void onClick(Player clicker, ClickType clickType) {
                    ...
                    int newVl = updateCheckVl(check, 10, true);
            ...
            gui.addButton(new Button(1, 15, ItemUtil.makeItem(
                    Material.getMaterial("STAINED_GLASS_PANE"), (short) 5, 1,
                    cfg.getGuiHighlightColor() + "§21VL", Arrays.asList(
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                            "§7Additon by §21 vl",
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
            ...
            gui.addButton(new Button(1, 16, ItemUtil.makeItem(
                    Material.getMaterial("STAINED_GLASS_PANE"), (short) 5, 1,
                    cfg.getGuiHighlightColor() + "§25VL", Arrays.asList(
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                            "§7Additon by §25 vl",
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
                    ))) {
            ...
            gui.addButton(new Button(1, 17, ItemUtil.makeItem(
                    Material.getMaterial("STAINED_GLASS_PANE"), (short) 5, 1,
                    cfg.getGuiHighlightColor() + "§210VL", Arrays.asList(
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                            "§7Additon by §210 vl",
                            "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤"
                    ))) {
    ...
    public static String getCheckMark(String name, boolean ab) {
        if(ab) {
            if(Karhu.getInstance().getCheckState().isAutoban(name)) {
                return "§a✔";
            } else {
                return "§c✗";
            }
        } else {
            if(Karhu.getInstance().getCheckState().isEnabled(name)) {
                return "§a✔";
            } else {
                return "§c✗";
            }
    ...
    public static void updateCheckMiddle(Button button, CheckInfo checkInfo, String name) {
        ...
        meta.setLore(checkInfo.credits().equals("")
                ? Arrays.asList(
                "§7§m⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤⏤",
                "§7Enabled: " + getCheckMark(name, false),
                "§7Punishable: " + getCheckMark(name, true),
        ...
        stack.setType(Karhu.getInstance().getCheckState().isEnabled(checkInfo.name())
