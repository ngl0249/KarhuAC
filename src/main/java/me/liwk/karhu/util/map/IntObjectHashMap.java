...
public class IntObjectHashMap<V> implements IntObjectMap<V> {
    ...
    public void putAll(Map<? extends Integer, ? extends V> sourceMap) {
        if (sourceMap instanceof IntObjectHashMap) {
            ...
            Iterator<? extends Entry<? extends Integer, ? extends V>> var2 = sourceMap.entrySet().iterator();

            while(var2.hasNext()) {
                Map.Entry<? extends Integer, ? extends V> entry = var2.next();
    ...
    private final class KeySet extends AbstractSet<Integer> {
        ...
        public boolean retainAll(Collection<?> retainedKeys) {
            ...
            while(iter.hasNext()) {
                IntObjectMap.PrimitiveEntry<V> entry = (PrimitiveEntry<V>)iter.next();
