...
public final class VersionBridgeHelper {
    ...
    public static boolean isValidAttack(KarhuPlayer data, boolean sprinting, ItemStack s, Entity entity) {
        ...
        if (!data.isNewerThan8()) {
            ...
            float f2 = Karhu.SERVER_VERSION.isNewerThanOrEquals(ServerVersion.V_1_16) ? data.getBukkitPlayer().getAttackCooldown() : Karhu.SERVER_VERSION.isNewerThanOrEquals(ServerVersion.V_1_9) ? 1 /*AttackIndicator.getCurrentCharge(data.getBukkitPlayer(), 1)*/ : 1;
