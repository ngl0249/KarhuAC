...
import me.liwk.karhu.util.mc.optifine.OptifineTrig;
...
public class MathHelper {
    ...
    {
        return fastMath ? OptifineTrig.sin(value) : SIN_TABLE[(int)(value * 10430.378F) & 65535];
    }
    ...
    {
        return fastMath ? OptifineTrig.cos(value) : SIN_TABLE[(int)(value * 10430.378F + 16384.0F) & 65535];
    }
    ...
    public static int floorBasic(double d) {
